...
public class AppFrame extends JFrame {
	...
	public AppFrame() {
		...
		connectPanel.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"Подключение", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		parametrsPanel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null),
				"Параметры подключения", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		baundrateComboBox.setModel(new DefaultComboBoxModel<>(new String[] { "110", "300", "600", "1200", "2400",
		...
		parityComboBox
				.setModel(new DefaultComboBoxModel<>(new String[] { "NONE", "ODD", "EVEN", "MARK", "SPACE" }));
	...
	private void setCoreParametrsFromUI() {
